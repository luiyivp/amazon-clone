          ...
          <div class="col-lg-3 col-md-3 col-sm-4">
            <div class="leftCol">
              ...
              <div class="imgBlock">
                <div class="eBooksing">
                  <img
                    :src="'http://localhost:3000/api/photos/' + product.photo.split('\\')[1]"
                    class="img-fluid"
                  />
                </div>
              </div>
                  ...
                  <ul>
                    ...
                    <li class="swatchElement" style="width: 117px;">
                      <span class="a-list-item">
                        ...
                        <span class="tmn-olp-links"></span>
                        <span class="tmn-olp-links">
                ...
                <div class="row">
                  <div class="col-sm-4 mb-1">
                    <div class="a-declarative">
                      Length:
                      <span
                        ><a href="#">386 pages <i class="a-icon a-icon-popover"></i></a
                      ></span>
                    </div>
                  </div>
                </div>
                ...
                <span class="a-declarative">
                  <a href="#" class="a-link-normal">
                    <div class="a-row a-spacing-mini">
                      ...
                      <span class="a-size-small">Deliver ti California</span>
                    </div>
                  </a>
                </span>
                <br />
                  ...
                  <div class="authorContent">
                    <div class="authorImageSingle">
                      <a href="#">
                        <img
                          :src="
                            'http://localhost:3000/api/photos/' + product.owner.photo.split('\\')[1]
                          "
                          class="img-fluid"
                        />
                      </a>
