          ...
          <div class="col-sm-6">
            ...
            <div class="a-section">
              ...
              <div class="a-section a-spacing-none a-spacing-top-small">
                <b>
                  Or pick up your packages at your convenience from our self-service locations. To
                  add an Amazon Pickup Point or Locker, click
                  <a href="#">here</a>.
                </b>
              </div>
              <!-- Error Message -->
              ...
              <form>
                <div class="a-spacing-medium a-spacing-top-medium">
                  ...
                  <div>
                    <span
                      >If the address contains typos or other errors, your package may be
                      undeliverable.</span
                    >
                  </div>
  ...
  export default {
    async asyncData({ $axios, params }) {
      try {
        ...
        let [countryResponse, addressResponse] = await Promise.all([response, singleAddress]);
