    ...
    <div class="container-fluid">
      <div class="shipping-address">
                      ...
                      >
                        <div class="row">
                          ...
                          <div class="col-sm-3 col-3">
                            <img
                              :src="
                                'http://localhost:3000/api/photos/' + product.photo.split('\\')[1]
                              "
                              style="width: 100px;"
                            />
                          </div>
                          ...
                          <div class="col-sm-9 col-9">
                            ...
                            <div class="a-row">
                              <!-- Product's quantity -->
                              <strong>Quantity: {{ product.stockQuantity }}</strong>
                            </div>
                              ...
                              <div class="a-row a-spacing-top-micro">
                                <span class="a-button-small">
                                  <span class="a-button-inner">
                                    ...
                                    <a href="#" class="a-button-text gift-popover-link"
                  ...
                  <div class="a-row">
                    ...
                    <div class="order-summary" style="font-size: 12px;">
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-6 text-right">USD {{ shippingPrice.price }}</div>
                      </div>
                      <div class="row mt-2">
                ...
                <div class="a-box-inner">
                  ...
                  <div class="a-size-mini">
                    <div class="a-row a-spacing-mini mb-1">
                      Please note that your country may charge import duties, taxes and fees that
                      you may have to pay ahead of delivery.
                      <a href="#">Learn more</a>
                    </div>
                    <div class="a-row a-spacing-mini mb-1">
        ...
        <div class="a-row a-spacing-small a-spacing-top-small">
          ...
          <p class="a-color-secondary a-size-mini">
            For an item sold by Amazon.com: When you click the "Place your order" button, we'll send
            you an email message acknowledging receipt of your order. Your contract to purchase an
            item will not be complete until we send you an email notifying you that the item has
            been shipped.
          </p>
          <p id="state-sales-tax-info" class="a-color-secondary a-size-mini">
            Colorado, Oklahoma, South Dakota and Vermont Purchasers:
            <a href="#">Important information regarding sales tax you may owe in your State</a>
          </p>
          <div class="a-color-secondary a-size-mini">
            <p class="a-color-secondary a-size-mini">
              ...
              condition. Exceptions and restrictions apply. See Amazon.com's
              <a href="#">Returns Policy</a>
              <br />
              <br />Go to the <a href="#">Amazon.com homepage</a> without completing your order.
            </p>
          </div>
        </div>
        <hr />
        <p class="a-size-small a-text-center a-color-secondary" data-testid>
          <a href="#">Conditions of Use</a> | <a href="#">Privacy Notice</a> © 1996-2019,
          Amazon.com, Inc.
        </p>
      </div>
    </div>
